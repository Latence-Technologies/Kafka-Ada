...
begin
	...
	Config := Kafka.Config.Create_Config;
	Kafka.Config.Set_Config(Config, "client.id", GNAT.Sockets.Host_name);
	Kafka.Config.Set_Config(Config, "bootstrap.servers", "localhost:9092");
